...
void setup() 
{
  ...
  Serial.println(dev.divider);
  
  Serial.print("N: ");
  Serial.println(dev.N, 6); // Print with 6 decimal places
  
  Serial.print("INTVal: ");
  Serial.println(dev.INTVal);
  
  Serial.print("MODVal: ");
  Serial.println(dev.MODVal);
  
  Serial.print("FRACVal: ");
  Serial.println(dev.FRACVal);
  
  Serial.print("GCDVal: ");
  Serial.println(dev.GCDVal);
  for (int i = 0; i < 6; i++) {
